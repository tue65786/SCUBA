 ...
 * <td> tag. When wrapping in <td> tag, substitute "&nbsp;" (HTML non-breaking
 * space) for empty string. If this was not done, the cell in the HTML table
 * will not show its border and usually would not look right.
 */
