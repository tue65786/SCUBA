 ...
 * <p/>
 * This class requires an open database connection for its constructor method. WebUserMods.java: in
 * this version, a new method: insert is added (to the delete method that was there from before).
 * The insert method takes a Validate object (with the typed data), creates the PreparedStatement
